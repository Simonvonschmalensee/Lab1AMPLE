...
HD_PWD='C:/Users/Simon/Desktop/lab1_2/fourBitCounter/fourBitCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log four_bit_counter.vds -m64 -mode batch -messageDb vivado.pb -notrace -source four_bit_counter.tcl
